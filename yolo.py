...
#     results = model.train(
#     data='E:/Autonomus Veh/training road/Lane-Detection-2-3/data.yaml',
#     epochs=50,
#     imgsz=416,
#     batch=2,
...
model = YOLO('E:/Autonomus Veh/training road/runs/segment/roboflow_yolov8_custom/weights/best.pt')  # Load the trained model

# # Perform inference on a test image
results = model('E:/Autonomus Veh/training road/Lane-Detection-2-3/test/images')  # Replace with the path to your test image
